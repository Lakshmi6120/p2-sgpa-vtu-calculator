...
<head>
 ...
 <meta name="keywords" content="SGPA_CALCULTOR, sgpa_calculator, calculator, calculate, 
diploma sgpa calculator, ploytechnic calculator">
...
<?php
 ...
 $lab1 = $_POST['lab1'];
 $lab2 = $_POST['lab2'];
 if(empty($subject1) || empty($subject2) || empty($subject3) || empty($subject4) || 
empty($subject5) || empty($subject6) || empty($lab1) || empty($lab2)){
 $msg = "<div class='alert alert-danger'>Feild must not be empty..!</div>";
 }else{
 
 
 
 $result = (($subject1 + $subject2 + $subject3 + $subject4 + $subject5 + $subject6 + $lab1 + 
$lab2)*100/800)/9.5;
 }
 }
?>
 ...
 <td><input class="form-control" type="text" placeholder="Enter marks out of 100" 
name="subject1"></td>
 </tr>
 <tr>
...
name="lab2"></td>
 ...
 <?php 
 if(isset($result)){?>
 <p class="text-center text-success lead">Your Result is : <strong ><?php echo 
number_format((float)$result,2,'.',''); ?></strong></p>
 <?php }?>
